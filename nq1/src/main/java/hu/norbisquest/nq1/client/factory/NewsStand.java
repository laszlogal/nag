...
import hu.norbisquest.nq1.client.data.model.NewsStandModel;
import hu.norbisquest.nq1.client.game.stages.S05NewsStand;
	...
	public static void create(final ScreenParent parent) {
		GWT.runAsync(new StageAsyncCreator() {
			...
			public StageFactory createFactory() {
				return StageFactory1.create(parent, new NewsStandModel());
			}

			@Override
			public void createStage(StageFactory factory) {
				parent.onScreenCreated(new S05NewsStand(factory));
			}
		});
	}
}
