...
import hu.norbisquest.nq1.client.data.model.VRKFrontModel;
import hu.norbisquest.nq1.client.game.stages.S08VRKFront;
	...
	public static void create(final ScreenParent parent) {
		GWT.runAsync(new StageAsyncCreator() {
			...
			public StageFactory createFactory() {
				return StageFactory1.create(parent, new VRKFrontModel());}

			@Override
			public void createStage(StageFactory factory) {
				parent.onScreenCreated(new S08VRKFront(factory));
			}
		});
	}
