...
import hu.norbisquest.nq1.client.data.model.RockKlubModel;
import hu.norbisquest.nq1.client.game.stages.S09RockKlub;
	...
	public static void create(final ScreenParent parent) {
		GWT.runAsync(new StageAsyncCreator() {
			...
			public StageFactory createFactory() {
				return StageFactory1.create(parent, new RockKlubModel());
			}

			@Override
			public void createStage(StageFactory factory) {
				parent.onScreenCreated(new S09RockKlub(factory));
			}
		});
	}
}
