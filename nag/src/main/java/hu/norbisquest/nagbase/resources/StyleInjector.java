 ...
 * the License.
 */
package hu.norbisquest.nagbase.resources;
...
import hu.norbisquest.nagbase.core.StringUtil;
...
public class StyleInjector {
	 ...
	 * resource class name
	 */
	private static final String CLASSNAME = "ggw_resource";
	...
	static class StyleInjectorImpl {
		...
		void setContents(StyleElement style, String contents) {
	...
	private static StyleElement createElementGGB() {
	 ...
	 *            the CSS contents of the stylesheet
	 * @param immediate
	 *            if {@code true} the DOM will be updated immediately
	 ...
	 */
	private static void inject(String css, boolean immediate) {
		toInject.add(css);
		inject(immediate);
	}
	...
	/**
	 * The {@code which} parameter is used to support the deprecated API.
	 */
